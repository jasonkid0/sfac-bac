...
$pdf ->AddPage();
    ...
    $pdf->Cell(50);
    // //cell(width,height,text,border,end line,[align])
    $pdf->Cell(103,4,'BACHELOR OF ARTS IN PSYCHOLOGY',0,0,'C');
...
$pdf ->Cell(90 ,4,'Ethics w/ Peace Education',0,0);
$pdf ->Cell(10 ,4,'3',0,0);
$pdf ->Cell(10 ,4,'0',0,0);
$pdf ->Cell(10 ,4,'3',0,0);
