...
$pdf->Cell(50);
// //cell(width,height,text,border,end line,[align])
$pdf->Cell(90, 4, '(For Business Undegraduate)', 0, 1, 'C');
...
$pdf->Cell(90, 4, 'Asian Business Environment with Business', 0, 0);
$pdf->Cell(10, 4, '3', 0, 0);
$pdf->Cell(10, 4, '', 0, 0);
$pdf->Cell(10, 4, '', 0, 0);
$pdf->Cell(10, 4, '', 0, 1);
...
$pdf->Cell(50);
// //cell(width,height,text,border,end line,[align])
$pdf->Cell(90, 4, '* Course can be taken after passing the Comprehensive Examination', 0, 1, 'C');
