...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(35, 3, $date, 'B', 0, 'L'); // for data
...
$pdf->Cell(78, 5, $row['elem'], 'B', 0, 'C'); // for data
$pdf->Cell(20, 6, 'School Year:', 0, 0);
$pdf->Cell(65, 5, $row['elemSY'], 'B', 1, 'C'); // for data
$pdf->Cell(27, 6, 'School Address', 0, 0);
$pdf->Cell(78, 5, $row['elemAddress'], 'B', 1, 'C'); // for data
...
$pdf->Cell(27, 6, 'Name of School', 0, 0);
$pdf->Cell(78, 5, $row['lastschool'] .' '. $last_school_type, 'B', 0, 'C'); // for data
$pdf->Cell(20, 6, 'School Year:', 0, 0);
...
$pdf->Cell(78, 5,   $row['lastschool'].' '. $last_school_type, 'B', 0, 'C'); // for data
$pdf->Cell(20, 6, 'School Year:', 0, 0);
$pdf->Cell(65, 5, $row['lastSY'], 'B', 1, 'C'); // for data
$pdf->Cell(27, 6, 'School Address', 0, 0);
$pdf->Cell(78, 5, $row['lastAddress'], 'B', 0, 'C'); // for data
$pdf->Cell(27, 6, 'Course and Major', 0, 0);
$pdf->Cell(58, 5, '', 'B', 1, 'C'); // for data
}
