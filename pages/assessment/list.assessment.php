                                ...
                                <div class="">
                                    <form method="GET" enctype="multipart/form-data" action="list.assessment.php">
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control" name="status" id="year_lvl">
                                                    <?php
                                                    if (isset($_GET['status'])) {
                                                    ?>
                                                    <option selected value="<?php echo $_GET['status']?>"><?php echo $_GET['status']?></option>
                                                        <?php
                                                        if ($_GET['status'] == 'Paid') {
                                                        ?>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover nowrap responsive" id="datatable-basic">
                                ...
                                <tbody>
                                    ...
                                    WHERE tbl_schoolyears.sem_id = '$sem_id' AND tbl_schoolyears.ay_id = '$ay_id' AND tbl_assessed_tf.status = '$_GET[status]' AND
