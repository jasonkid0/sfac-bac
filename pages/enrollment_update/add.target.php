            ...
            <div class="row mb-10">
                <div class="col-lg-9 col-12 mx-auto">
                    <div class="card card-body mt-4 shadow-sm">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="userData/ctrl.add.target.php">

                            <div class="row">
                                <div class="col-sm-6">
                                    <label>Academic Year</label>
                                    <select class="form-control" id="academic_year" name="ay_id">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="text" placeholder="New Enrollees"
                                        name="target_new[]" />
                                </div>
                                <div class="col-sm-6">
                                    <label class="mt-2">Target Old Enrollees</label>
                                    <input class="form-control" type="text" placeholder="Old Enrollees"
                                        name="target_old[]" />
                                </div>
                            </div>
