                            ...
                            <table class=" table table-hover responsive nowrap m-0" id="datatable-basic"
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['search'])) {
                                        ...
                                        $pendStud = $db->query("SELECT *, CONCAT(S.firstname, ' ', S.middlename, ' ', S.lastname) AS fullname, SY.updated_by, SY.created_at
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['updated_by']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['last_update']; ?></td>
                                        <td class="text-sm font-weight-normal">
