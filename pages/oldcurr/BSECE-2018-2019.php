...
$pdf->Cell(50);
// //cell(width,height,text,border,end line,[align])
$pdf->Cell(103, 4, 'BACHELOR OF SCIENCE IN ELECTRONICS ENGINEERING (BSECE)', 0, 0, 'C');
...
$pdf->Cell(10, 4, '1', 0, 0);
$pdf->Cell(10, 4, '4', 0, 0);
$pdf->Cell(10, 4, '3RD YR STAD. 2ND SEM', 0, 1);
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(15, 6, 'Student must complete all required Third Year Courses before acceptance of enrollment in PRAC 111.', 0, 1);
