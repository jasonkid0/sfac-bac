...
$pdf ->AddPage();
    ...
    $pdf->Cell(50);
    // //cell(width,height,text,border,end line,[align])
    $pdf->Cell(103,4,'BACHELOR OF ELEMENTARY EDUCATION (BEED)',0,0,'C');
...
$pdf ->Cell(45 ,20,'Third Year, Second Semester',0,1);
$pdf->SetFont('Arial','','9');
// SUBJECTS
...
$pdf ->Cell(3 ,4,'6','B',0);
$pdf->Cell(7, 4, '', 0, 0);
$pdf ->Cell(10 ,4,'ELED 111 & 112   *540H',0,1);
...
;
$pdf ->Cell(73 ,5,'',0,0);
$pdf ->Cell(84 ,6,'(including NSTP 6 units)',0,0);
