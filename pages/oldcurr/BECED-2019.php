...
$pdf ->AddPage();
    ...
    $pdf->Cell(90,3,'96 Bayanan, City of ' .$test. ' Bacoor',0,0,'C');
    // Line break
    $pdf->Ln(8);
    ...
    $pdf->Cell(50);
    // //cell(width,height,text,border,end line,[align])
    $pdf->Cell(103,4,'BACHELOR OF EARLY CHILDHOOD EDUCATION (BECED)',0,0,'C');
    ...
    $pdf->Cell(50);
    // //cell(width,height,text,border,end line,[align])
    $pdf->Cell(110,4,'(Effective Academic Year 2019-2020)',0,1,'C');
     // Line break
    $pdf->Ln(4);
